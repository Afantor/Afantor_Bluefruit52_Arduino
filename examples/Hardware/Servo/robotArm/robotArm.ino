...
void setup() {
    Serial.begin(115200);
  	servo0.attach(20);  // attaches the servo on P0.02 Pin to the servo object
    servo1.attach(10);  // attaches the servo on P0.02 Pin to the servo object
    servo2.attach(14);  // attaches the servo on P0.02 Pin to the servo object
}
