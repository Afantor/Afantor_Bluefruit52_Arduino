...
#ifndef _AFANTOR_SPITFT_H_
#define _AFANTOR_SPITFT_H_
...
// If DMA is enabled, Arduino sketch MUST #include <Afantor_ZeroDMA.h>
// Estimated RAM usage:
...
/*!
  @brief  Afantor_SPITFT is an intermediary class between Afantor_GFX
          ...
          the comments.
*/
class Afantor_SPITFT : public Afantor_GFX {
  ...
  public:
    ...
    Afantor_SPITFT(uint16_t w, uint16_t h,
    ...
    Afantor_SPITFT(uint16_t w, uint16_t h, SPIClass *spiClass,
      int8_t cs, int8_t dc, int8_t rst = -1);
#endif // end !ESP8266
    ...
    Afantor_SPITFT(uint16_t w, uint16_t h, tftBusWidth busWidth,
    ...
    */
    ...
    using        Afantor_GFX::drawRGBBitmap; // Check base class first
    ...
    // Afantor_SPITFT_Macros.h. Some have been made into inline functions
  ...
  protected:
    ...
    Afantor_ZeroDMA dma;                  ///< DMA instance
